...
APP_NAME = "SaveState"
APP_VERSION = "3.0" # Restored APP_VERSION
...
LINUX_SKIP_HOME_FALLBACK = False          # Set True to skip exact-title folders directly under the home directory
...
LINUX_MAX_DIRECTORIES_TO_EXPLORE = 200    # Per-root traversal cap (relevance matches are visited first)
LINUX_MAX_RESULTS = 20                    # Keep the selection dialog focused on high-confidence candidates
...
LINUX_STRICT_SAVE_EXTENSIONS = {
    'sav', 'save', 'slot', 'sl2', 'state', 'gci', 'srm', 'mcr', 'mc',
    'ess', 'fos', 'lsf', 'lsb', 'eep', 'fla', 'profile', 'ark', 'rws'
}
